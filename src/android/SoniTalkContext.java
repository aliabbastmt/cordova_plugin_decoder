    ...
    */
        ...
        private static void createStatusNotificationChannel(Context context) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                String resource_text = context.getString(context.getResources().getIdentifier("statusChannelName", "string", context.getPackageName()));

                NotificationChannel statusChannel = new NotificationChannel(NOTIFICATION_STATUS_CHANNEL_ID, resource_text, channelImportance);
        ...
        private static void initStatusNotification(Context context, EnumSet<State> states){
            ...
            if (states.containsAll(EnumSet.of(State.RECEIVING, State.SENDING))) {
                title = context.getString(context.getResources().getIdentifier("sendingAndReceivingStatusNotificationTitle", "string", context.getPackageName()));
                content = context.getString(context.getResources().getIdentifier("sendingAndReceivingStatusNotificationMessage", "string", context.getPackageName()));
                icon = context.getResources().getIdentifier("st_send_white_receive_white", "drawable", context.getPackageName());
            }
            else if (states.contains(State.RECEIVING)) {
                title = context.getString(context.getResources().getIdentifier("receivingStatusNotificationTitle", "string", context.getPackageName()));
                content = context.getString(context.getResources().getIdentifier("receivingStatusNotificationMessage", "string", context.getPackageName()));
                icon = context.getResources().getIdentifier("st_send_grey_receive_white", "drawable", context.getPackageName());
            }
            else if (states.contains(State.SENDING)) {
                title = context.getString(context.getResources().getIdentifier("sendingStatusNotificationTitle", "string", context.getPackageName()));
                content = context.getString(context.getResources().getIdentifier("sendingStatusNotificationMessage", "string", context.getPackageName()));
                icon = context.getResources().getIdentifier("st_send_white_receive_grey", "drawable", context.getPackageName());
            }
            else {
                title = context.getString(context.getResources().getIdentifier("defaultStatusNotificationTitle", "string", context.getPackageName()));
                content = context.getString(context.getResources().getIdentifier("defaultStatusNotificationMessage", "string", context.getPackageName()));
                icon = context.getResources().getIdentifier("st_send_grey_receive_grey", "drawable", context.getPackageName());
            }
